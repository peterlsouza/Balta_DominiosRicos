...
namespace Payment.Domain.Entities
{
    ...
    {
        protected PaymentMethod(DateTime paidDate, DateTime expireDate, decimal total, decimal totalPaid, string payer, Document document, Address address, Email email)
        {
